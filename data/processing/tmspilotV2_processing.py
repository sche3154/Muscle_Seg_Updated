...
class TmsPilotV2Processing(BaseProcessing):
    ...
    def preprocessing(self, sample):
        ...
        thigh_data_bounded = thigh_data[bb[0]:bb[1], bb[2]:bb[3], bb[4]:bb[5]]
    ...
    def postprocessing(self, preprocessed_sample, output_dict):
        ...
        for key, value in output_dict.items():
            ...
            if self.opt.input_patch_size > 0:
                ...
                if key is 'pred':
                    resulted_img[resulted_img > 0.4] = 1.
                    resulted_img[resulted_img <= 0.4] = 0.
